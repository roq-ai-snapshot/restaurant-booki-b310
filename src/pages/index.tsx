  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Simplifying Table Reservations and Menu Management for Your Restaurant. A Seamless Experience for Both Customers and Employees."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Simplifying Table Reservations and Menu Management for Your Restaurant. A Seamless Experience for Both Customers and Employees.`}
            </Text>
            <Box
